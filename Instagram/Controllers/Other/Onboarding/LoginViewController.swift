...
class LoginViewController: UIViewController {
    ...
    private func configureHeaderView(){
        ...
        let logo = UIImageView(image: UIImage(named: "text"))
    ...
    @objc private func didTapLoginButton(){
        ...
        AuthManager.shared.loginUser(username: username,email: email,password: password) { success in
            ...
            //to mexendo com UI, então precisa ser na main thread
            DispatchQueue.main.async {
                if success {
                    ...
                    let alert = UIAlertController(title: "Log in Erro", message: "We were unable to log you in.", preferredStyle: .alert)
...
extension LoginViewController: UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        if textField == usernameEmailField {
            passwordField.becomeFirstResponder() // esse campo ganha o foco
        }
